...
//       );
//       notifySuccess(currentlyBlocked ? FRONTEND_MESSAGE_CONSTANTS.SUCCESS.TENANT_UNBLOCKED : FRONTEND_MESSAGE_CONSTANTS.SUCCESS.TENANT_BLOCKED);
//     } catch (error: any) {
...
//     // Basic implementation for demonstration. A modal might be better.
//     const newName = prompt("Enter new name:");
//     if (!newName) return;

//     try {
//       await superAdminService.updateTenantName(id, newName);
//       setData((prev) => prev.map((t) => (t.id === id ? { ...t, name: newName } : t)));
//       notifySuccess(FRONTEND_MESSAGE_CONSTANTS.SUCCESS.TENANT_NAME_UPDATED);
//     } catch (error) {
//       console.error(error);
//       notifyError(FRONTEND_MESSAGE_CONSTANTS.ERROR.FAILED_UPDATE_TENANT_NAME);
//     }
//   };
...
//               <button
//                 onClick={() => handleEditName(tenant.id)}
