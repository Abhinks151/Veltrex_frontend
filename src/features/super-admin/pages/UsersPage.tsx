...
const UsersPage = () => {
  ...
  const handleToggleBlock = async (
    ...
    try {
      ...
      notifySuccess(
        currentlyBlocked ? FRONTEND_MESSAGE_CONSTANTS.SUCCESS.USER_UNBLOCKED : FRONTEND_MESSAGE_CONSTANTS.SUCCESS.USER_BLOCKED
      );
    } catch (error: unknown) {
        ...
        return (
          <div className="flex gap-2">
            <button
              ...
              className={`px-3 py-1.5 rounded text-sm font-medium transition-colors ${user.isBlocked
